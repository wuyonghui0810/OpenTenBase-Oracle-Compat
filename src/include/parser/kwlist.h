...
PG_KEYWORD("checksum", CHECKSUM, UNRESERVED_KEYWORD)
...
PG_KEYWORD("dual", DUAL, UNRESERVED_KEYWORD)
...
PG_KEYWORD("getterm", GETTERM, UNRESERVED_KEYWORD)
...
PG_KEYWORD("opentenbase", OPENTENBASE_P, UNRESERVED_KEYWORD)
#endif
...
PG_KEYWORD("persistently", PERSISTENTLY, UNRESERVED_KEYWORD)
...
PG_KEYWORD("priority", PRIORITY, UNRESERVED_KEYWORD)
...
PG_KEYWORD("readable", READABLE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("reject", REJECT_P, UNRESERVED_KEYWORD)
...
PG_KEYWORD("rownum", ROWNUM, UNRESERVED_KEYWORD)
...
PG_KEYWORD("setterm", SETTERM, UNRESERVED_KEYWORD)
#ifdef __OPENTENBASE_C__
PG_KEYWORD("shardcluster", SHARDCLUSTER, RESERVED_KEYWORD)
#endif
#ifdef _SHARDING_
